...
from nv_files.train_nvs import train_pinn_vortice
...
def get_deepgalerkin_config():
    ...
    wandb.project = "Vorticity-training"
    wandb.name = "vorticity_MDNN"
    wandb.tag = None

    # General settings
    config.nn_model = "MDNN"  # Options: "NN", "WRF", "MDNN"
    config.lambdas = {"nvs":1, "cond":1, "w0":1}
...
pinn_nvs = train_pinn_vortice(config,device=device)